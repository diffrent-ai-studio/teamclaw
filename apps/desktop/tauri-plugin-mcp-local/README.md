...
# 2. Register in apps/desktop/src/main.rs (debug builds only!)
...
In your app's `apps/desktop/Cargo.toml`, add the plugin dependency:
...
In your `apps/desktop/src/main.rs` (or `lib.rs` for mobile):
